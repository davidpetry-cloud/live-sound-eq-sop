    ...
    "channels": [
      ...
      },
      {
        ...
        "mic": {
          ...
          "note": "Live-sound sources caution against the MD421 on trumpet specifically — several engineers describe it as too hot/bright here, better suited to trombone's lower range. One source calls the SM57 a mediocre trumpet mic for studio work, but a live-specific thread rates it fine for handling stage SPL. Research synthesis, not yet verified on this rig."
        }
      },
      {
        "name": "TROMBONE",
        ...
        "mic": {
          "cheap": "SM57 or MD421",
          "note": "MD421 is the most consistently recommended mic for trombone across both live and studio sources. SM57 is the cheaper fallback and handles live SPL fine, though it's described as the budget option rather than the preferred one. Sources disagree on HPF placement for trombone specifically — 80 Hz and 150 Hz both appear. Research synthesis, not yet verified on this rig."
        }
      },
      {
        "name": "ALTO SAXOPHONE",
